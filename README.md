...
```bash
pip install git+https://github.com/data-scrape/awesome-lead-generation.git
```

### From source

```bash
git clone https://github.com/data-scrape/awesome-lead-generation.git
...
1. **⭐ Star this repository** — [Click here to star](https://github.com/data-scrape/awesome-lead-generation)
2. **📧 Share with your network** — Help others discover this tool
3. **🐛 Report issues** — [Open an issue](https://github.com/data-scrape/awesome-lead-generation/issues) if you find a bug
...
[![Star History](https://img.shields.io/github/stars/data-scrape/awesome-lead-generation?style=social)](https://github.com/data-scrape/awesome-lead-generation)
